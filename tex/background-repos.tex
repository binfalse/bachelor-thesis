...
Commonly imported ontologies are System Biology Ontology\footnote{\todo{get link to SBO}} (SBO), Gene Ontology\footnote{\todo{go link}} (GO), KiSAO\footnote{\todo{kisao link}} and Chebi Ontology\footnote{\todo{Link to chebi}}
